...
const settings = [
  ...
  },
  {
    ...
    icon: (
      <MaterialIcons name="account-balance-wallet" size={20} color="#121217" />
    ),
    GoToPage: "Payouts",
  },
  {
    content: "Contact Us",
    icon: <MaterialIcons name="support-agent" size={20} color="#121217" />,
    GoToPage: "ContactUs",
  },
  {
    content: "Logout",
        ...
        >
          ...
          <View style={styles.profileSection}>
            ...
            <Text style={styles.nameText}>
              {seller?.user_name || seller?.f_name || "Your Name"}
            </Text>
            <View style={styles.subdomainCard}>
              <Text style={styles.subdomainText}>
                @{seller?.subdomain || "subdomain"}
              </Text>
              <TouchableOpacity
                onPress={() => {
              ...
              <TouchableOpacity
                ...
                onPress={() => {
                  if (setting.GoToPage === "Logout") {
                    ...
                    navigation.navigate(setting.GoToPage, {
                      sellerId: seller?.id,
